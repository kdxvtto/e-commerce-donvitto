      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className="space-y-6 lg:w-1/2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl">
            {[
              { label: 'Pelanggan puas', value: '150K+' },
              { label: 'Rating rata-rata', value: '4.8/5' },
              { label: 'Produk tersedia', value: '12.5K' },
            ].map((item) => (
              <div
                key={item.label}
          ...
          <div className="flex flex-wrap gap-3">
            {['Elektronik', "Men's Fashion", "Women's Fashion", 'Home Appliances', 'Food & Beverages', 'Sports', 'Beauty'].map(
              (tag) => (
                <span
                  key={tag}
          ...
          <div className="relative flex flex-col gap-6">
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl p-4">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-200/80">Electronics</p>
                  <p className="text-lg font-semibold">Noise-Cancelling Headphones</p>
                </div>
